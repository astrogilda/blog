...
export default function Home() {
  return (
    // We've removed the geistSans and geistMono classNames
    ...
    >
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        />
        {/*
          Tailwind's `font-mono` class will apply a standard monospace font.
          This is configured in your tailwind.config.mjs file.
        */}
